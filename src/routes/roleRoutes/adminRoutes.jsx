...
import SettledUnsettledTransactionsReports from '../../components/Reports/SettledUnsettledTransactionsReports.jsx';
...
const HeldTransactions = lazy(() => import('../../components/Admin/HeldTransactions.jsx'));
...
const UpdateTransaction = lazy(() => import('../../components/Admin/UpdateTransaction.jsx'));
...
export const adminRoutes = [
  ...
  {
    path: "monitoring/held-transactions",
    element: <HeldTransactions />
  },
  {
    path: "logs",
  ...
  // Reports
  {
    ...
    children: [
      ...
      { 
        ...
        element: <SettledUnsettledTransactionsReports />
      },
      { 
