...
const MerchantTransactionWithTaxesReports = ({ filters: commonFilters, userType }) => {
    ...
    const exportFullReport = async () => {
        ...
        try {
            ...
            const filename = disposition
                ...
                : `merchant_transactions_tax_${merchantType.toLowerCase()}_${localFilters.startDate}_to_${localFilters.endDate}.xlsx`;
    ...
    const generateFilename = () => {
        ...
        return `merchant_transaction_tax_report${type}_${dateRange}`;
    };
                        ...
                        <div className="flex gap-2">
                            {pagination.totalElements > 100 ? (
                                ...
                                <UniversalExportButtons
                                    ...
                                    title={`${isFranchiseMerchant ? 'Franchise' : 'Direct'} Merchant Transaction Report (Tax Details)`}
